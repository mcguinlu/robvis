...
In order to help users familiarize themselves with the package and its functionality, `robvis` contains built-in example datasets for each template. We illustrate the example data for the RoB 2 tool for assessing risk of bias in randomized trials in Table  \@ref(tab:robdata).
