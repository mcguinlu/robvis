...
test_that("ROB - Traffic light", {
  ...
  vdiffr::expect_doppelganger("TF - ROB2 - Overall", rob_traffic_light(data_rob2, "ROB2", overall = FALSE))
  ...
  vdiffr::expect_doppelganger("TF - ROB2C - Overall", rob_traffic_light(data_rob2_cluster, "ROB2-Cluster", overall = FALSE))
  ...
  vdiffr::expect_doppelganger("TF - ROBINS-I - Overall", rob_traffic_light(data_robins, "ROBINS-I", overall = FALSE))
  ...
  vdiffr::expect_doppelganger("TF - QUADAS - Overall", rob_traffic_light(data_quadas, "QUADAS-2", overall = FALSE))
  ...
  vdiffr::expect_doppelganger("TF - QUIPS - Overall", rob_traffic_light(data_quips, "QUIPS", overall = FALSE))
  ...
  vdiffr::expect_doppelganger("TF - ROBG - Overall", rob_traffic_light(data_rob2, "Generic", overall = FALSE))
