...
test_that("ROB - Traffic light", {
  ...
  expect_snapshot_file(name = "TF - ROBINS-I - Basic.png", rob_save(file = tempfile(fileext = ".png"), rob_traffic_light(data_robins_i, "ROBINS-I")))
  expect_snapshot_file(name = "TF - ROBINS-I - Point Size.png", rob_save(file = tempfile(fileext = ".png"), rob_traffic_light(data_robins_i, "ROBINS-I", psize = 10)))
  expect_snapshot_file(name = "TF - ROBINS-I - Colour - cochrane.png", rob_save(file = tempfile(fileext = ".png"), rob_traffic_light(data_robins_i, "ROBINS-I", colour = "cochrane")))
  expect_snapshot_file(name = "TF - ROBINS-I - Colour - colourblind.png", rob_save(file = tempfile(fileext = ".png"), rob_traffic_light(data_robins_i, "ROBINS-I", colour = "colourblind")))
  ...
  expect_snapshot_file(name = "TF - ROBINS-I-V2 - Basic.png", rob_save(file = tempfile(fileext = ".png"), rob_traffic_light(data_robins_i_v2, "ROBINS-I-V2")))
  expect_snapshot_file(name = "TF - ROBINS-I-V2 - Point Size.png", rob_save(file = tempfile(fileext = ".png"), rob_traffic_light(data_robins_i_v2, "ROBINS-I-V2", psize = 10)))
  expect_snapshot_file(name = "TF - ROBINS-I-V2 - Colour - cochrane.png", rob_save(file = tempfile(fileext = ".png"), rob_traffic_light(data_robins_i_v2, "ROBINS-I-V2", colour = "cochrane")))
  expect_snapshot_file(name = "TF - ROBINS-I-V2 - Colour - colourblind.png", rob_save(file = tempfile(fileext = ".png"), rob_traffic_light(data_robins_i_v2, "ROBINS-I-V2", colour = "colourblind")))
  expect_snapshot_file(name = "TF - ROBINS-I-V2 - Colour - custom.png", rob_save(file = tempfile(fileext = ".png"), rob_traffic_light(data_robins_i_v2, "ROBINS-I-V2", colour = c("#f442c8", "#bef441", "#000000", "#bef441", "#333333"))))
  expect_snapshot_file(name = "TF - ROBINS-I-V2 - Overall.png", rob_save(file = tempfile(fileext = ".png"), rob_traffic_light(data_robins_i_v2[1:7], "ROBINS-I-V2", overall = FALSE)))
