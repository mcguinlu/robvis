...
* The `rob_summary()` function was based on code forwarded by a colleague. I have recently learnt that this code was adapted from the wonderful "[Doing Meta-Analysis in R](https://bookdown.org/MathiasHarrer/Doing_Meta_Analysis_in_R/)" guide, so I would like to retrospectively acknowledge the authors for their indirect help. 
